  ...
  <DayNightLandscape>
    ...
    >
      ...
      <g id="boat" data-name="boat">
        ...
        />
        <path className="cls-17" d="M1042.08,537.5l-11.26,3.9v-7.8Z" />
      </g>
      <g id="boat-2" data-name="boat">
        ...
        />
        <path className="cls-17" d="M833.53,510.19l-15.46,5.35V504.83Z" />
      </g>
      ...
      <g id="Lighthouse">
        ...
        <rect
          ...
          height="3.72"
        />
        <path className="cls-21" d="M925.31,365.47l24,17h-48Z" />
        <rect
          className="cls-21"
          x="919.54"
          y="581.53"
        ...
        />
        <circle id="bulb" className="cls-24" cx="925.12" cy="389.64" r="5.11" />
        <circle
          id="glow"
          className="cls-25"
          cx="925.12"
      ...
      <rect id="ground" className="cls-26" y="607" width="1920" height="122" />
      <path
        id="water"
        className="cls-27"
      ...
      <g id="fish">
        ...
        />
        <circle className="cls-9" cx="997.52" cy="657.79" r="1.04" />
        <line
          className="cls-9"
          x1="992.18"
          y1="658.82"
      ...
      <g id="fish-2" data-name="fish">
        ...
        />
        <circle className="cls-9" cx="871.52" cy="635.81" r="1.04" />
        <line
          className="cls-9"
          x1="876.87"
          y1="636.85"
      ...
      <g id="fish-3" data-name="fish">
        ...
        />
        <circle className="cls-9" cx="954.76" cy="636.78" r="1.29" />
        <line
          className="cls-9"
          x1="948.09"
          y1="638.07"
